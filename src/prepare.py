...
oppening_data_path = api.read('dataset/opening_gross.csv', remote='dataset-track')

fin_data = pd.read_csv(StringIO(finantial_data_path))
movie_data = pd.read_csv(StringIO(movie_data_path))
opening_data = pd.read_csv(StringIO(oppening_data_path))
